...
const templates = ref([
  ...
  {
    code: 'FENCE_ENTER_ALERT',
    name: '围栏进入提醒',
    type: 'emergency',
    description: '老人进入电子围栏时发送的提醒短信',
    content: '【云护CloudCare】老人{elder_name}已进入电子围栏"{fence_name}"，当前位置：纬度{latitude}，经度{longitude}，事件时间：{event_time}，请及时关注。',
    params: [
      { key: 'elder_name', label: '老人姓名', placeholder: '张三' },
      { key: 'fence_name', label: '围栏名称', placeholder: '家庭安全区域' },
      { key: 'latitude', label: '纬度', placeholder: '30.783676' },
